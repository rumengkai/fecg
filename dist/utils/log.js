...
function displayHelpScreen() {
    console.log([
        ...
        "  $ fe                 " +
            chalk_1.default.dim("Select from a list of available generators"),
        "  $ fe <name>          " +
            chalk_1.default.dim("Run a generator registered under that name"),
        "  $ fe <name> [input]  " +
            chalk_1.default.dim("Run the generator with input data to bypass prompts"),
        "",
        chalk_1.default.bold("Options:"),
        "  -h, --help             " + chalk_1.default.dim("Show this help display"),
        "  -t, --show-type-names  " +
            chalk_1.default.dim("Show type names instead of abbreviations"),
        ...
        "  $ " + chalk_1.default.blue('fe table userList'),
        "",
    ].join("\n"));
}
